...
static const char *const test_msgs[] = {
    "LEEF:2.0|JSONAR|SONARG|2|783748000001276892|x7c|ruleID=QUERY|ruleDesc=QUERY|severity=NOTICE \
|devTime=Mar 28 2017 06:02:01|serverType=MS SQL SERVER|classification=ALL|category=ALL \
...
|srcPort=ALL|protocol=WINDOWS NAMED PIPES|type=QUERY|violationID=QUERY|sql=|error=0|sev=3|devTimeFormat=MMM dd yyyy HH:mm:ss",
    "LEEF:1.0|QRadar|Health Agent|7.2.4|QRadarHealthMetric|\
MetricID=DiskUsage\tDeploymentID=f074e12e-132f-11e7-aac5-000c29fb351f\tHostName=qradar\tComponentType=hostcontext \\t anotherhostcontext\t\
...
cs3Label=db cs3=DB2:SAMPLE cs4Label=count cs4=1 cs5Label=succeeded cs5=1 sev=3"};


// const int leef_seps_len = 22;
// static const char *const leef_seps_keys[] = {
//     "x7c", "0x7C", "x7C", "0x7c", "x5e", "0x5e", "x5E", "0x5E", "x3a",
